#!/bin/bash
#   setsid nohup sim/runners/ring_centre.sh > sim/results/ring_centre2.out 2>&1 &
set -u
cd /home/ttuser/ssh_analog/ct-worktree/sim/decks
for d in ring_centre2_ffm40 ring_centre2_ss125; do
...
echo "### RING_CENTRE2 DONE $(date +%H:%M)"
