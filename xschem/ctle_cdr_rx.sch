...
C {devices/ipin.sym} -830 10 0 0 {name=p3 lab=ibias}
...
C {devices/lab_wire.sym} -230 10 0 0 {name=l7 sig_type=std_logic lab=ibias}
...
C {devices/lab_wire.sym} -640 220 0 0 {name=p90 sig_type=std_logic lab=ibias}
C {devices/lab_wire.sym} -560 220 0 0 {name=p91 sig_type=std_logic lab=VGND}
