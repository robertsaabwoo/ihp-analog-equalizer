...
C {devices/lab_wire.sym} 0 -60 3 0 {name=p3 sig_type=std_logic lab=plus}
C {devices/lab_wire.sym} 0 120 3 1 {name=p4 sig_type=std_logic lab=minus}
C {devices/lab_wire.sym} -60 30 0 1 {name=p9 sig_type=std_logic lab=VNB}
