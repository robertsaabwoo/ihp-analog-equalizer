...
C {robs_xor.sym} 970 -250 0 0 {name=x6}
...
C {robs_xor.sym} 1420 -160 0 0 {name=x7}
...
C {d_flip_flop.sym} 560 -130 0 0 {name=x5}
C {d_flip_flop.sym} 560 60 0 0 {name=x1}
C {d_flip_flop.sym} 1000 -130 0 0 {name=x2}
C {d_flip_flop.sym} 970 60 0 0 {name=x3}
